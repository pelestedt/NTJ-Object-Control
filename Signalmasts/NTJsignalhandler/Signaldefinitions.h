...
const PROGMEM byte aspect[11][9][8]  =
{
  ...
  {                           //Aspekter för                     
    {off, blinking},          //Signaltyp 1
    {blinking, off}
  },
  {
    {off, off,blinking},       //Signaltyp 2
    {off, blinking, off},
  ...
  {
    {off, off, off, on, off},  //Signaltyp 6
    {off, off, off, off, on},
    {off, off, on, off, on},
    {off, off, blinking, off, on},
    {off, blinking, off, off, on},
    {blinking, off, blinking, off, on},
    {on, off, on, off, on},  
  },
  {

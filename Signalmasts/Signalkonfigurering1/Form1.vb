        ...
        Else
            ...
            If SerialPort1.IsOpen = False Then
                ...
                ProgramRGB.Visible = True
                    ...
                    End While
                TextBox_ReceivedMessage.Text = "Text från nano inkommet"
...
slut:
    ...
    Private Sub Kalibrera_Click(sender As Object, e As EventArgs) Handles Kalibrera.Click
        Kalibrera.Visible = False
        Kalib.Visible = True
        Kalib.Update()
        TextBox_ReceivedMessage.Clear()
